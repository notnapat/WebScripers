...
(async () => {
    try {
        ...
        await page.goto(
            "https://www.bnn.in.th/th/p/computer-hardware-diy/ram-computer-hardware-diy/ram-for-pc-computer-hardware-diy?sort_by=price_desc"
        );
        ...
        cpuAmdSources.name = await page.$$eval(
            ...
            (names) =>
                names
                    .filter((_, i) => [1, 4, 7, 11, 14,].includes(i))
