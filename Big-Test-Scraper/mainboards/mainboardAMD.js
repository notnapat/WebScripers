...
(async () => {
    try {
        ...
        await page.goto(
            "https://www.bnn.in.th/th/p/computer-hardware-diy/mainboard-computer-hardware-diy/amd-mainboard-computer-hardware-diy?sort_by=price_desc"
        );
        ...
        cpuAmdSources.name = await page.$$eval(
            ...
            (names) =>
                names
                    .filter((_, i) => [0, 1, 4, 5, 6, 7].includes(i))
